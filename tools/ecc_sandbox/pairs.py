...
def direct_pair(payload, raster, images_folder, order_index, step_override=None, extension=".bmp",
    ...
    Quy uoc dau: phai LAY AM gia tri tu measure_pitch() -- dung
    -result["right"]["mean_dx"] lam pitch_correction_px_per_step_x va
    -result["bottom"]["mean_dy"] lam pitch_correction_px_per_step_y (khong duoc dung truc tiep,
    khong doi dau se sai) -- xem ghi chu trong pitch_diagnostics.measure_pitch() cho phan trace day du.
    """
