...
{
    // [Codex] [Change time: 2026-07-27] [Purpose: Centralize configured-to-effective runtime mapping and reporting.]
    public static class AlignStitchConfigMapper
    {
        ...
        { 
            ...
            var g = new CommonGeometryOptions 
            { 
                MinOverlapRatio = n.Acceptance.MinOverlapRatio, 
                MaxTranslationPixels = n.Acceptance.MaxTranslationPixels, 
                MaxAbsRotationDeg = n.Acceptance.MaxAbsRotationDeg, 
                MinScale = n.Acceptance.MinScale, 
                MaxScale = n.Acceptance.MaxScale 
            }; 
        ...
        { 
            ...
            {
                case DirectCoarseMatcherKind.HalconNcc: return MatcherKind.HalconNcc;
                case DirectCoarseMatcherKind.HalconShapeModel: return MatcherKind.HalconShapeModel;
                case DirectCoarseMatcherKind.PyramidEcc: return MatcherKind.PyramidEcc;
                case DirectCoarseMatcherKind.PyramidPhaseCorrelation: return MatcherKind.PyramidPhaseCorrelation;
                case DirectCoarseMatcherKind.None: return null;
                default: throw new NotSupportedException("Unsupported direct coarse matcher: " + c.DirectAlignment.CoarseMatcher + ".");
            }
        }
        public static MatcherKind? ToDirectRefinementMatcherKind(AlignStitchConfig c) 
        {
            ...
            {
                case DirectRefinementMatcherKind.PyramidEcc: return MatcherKind.PyramidEcc;
                case DirectRefinementMatcherKind.PyramidPhaseCorrelation: return MatcherKind.PyramidPhaseCorrelation;
                case DirectRefinementMatcherKind.None: return null;
                default: throw new NotSupportedException("Unsupported direct refinement matcher: " + c.DirectAlignment.RefinementMatcher + ".");
            }
        }
        public static MatcherKind? ToNeighborCoarseMatcherKind(AlignStitchConfig c) 
        { 
            EnsureComposite(c); 
            return c.NeighborAlignment.CoarseMatcher == NeighborCoarseMatcherKind.None ? (MatcherKind?)null : MatcherKind.PyramidPhaseCorrelation; 
        }
        ...
        public static StitchFromGlobalTransformsOptions ToStitchingOptions(AlignStitchConfig c)
        {
            ...
            {
                OutputPath = string.IsNullOrWhiteSpace(c.Output.OutputPath) ? null : Path.Combine(c.Output.OutputPath, "Stitched.tiff"),
                PreviewUpdateInterval = c.Output.PreviewUpdateInterval, MaxPreviewMegapixels = c.Output.MaxPreviewMegapixels,
                TiffMode = c.Output.TiffMode, BigTiffTileWidth = c.Output.BigTiffTileWidth, BigTiffTileHeight = c.Output.BigTiffTileHeight,
                StitchingEngine = c.Stitching.Engine, EnableBlending = c.Stitching.EnableBlending, BlendMode = c.Stitching.BlendMode,
                ForceGray8Output = c.Stitching.ForceGray8Output, BlankFallbackOverlapPolicy = c.Stitching.BlankFallbackOverlapPolicy,
                AllowUnsafeLegacyHalconProjectiveMosaic = c.Stitching.AllowUnsafeLegacyHalconProjectiveMosaic
            };
        }
        private static MatcherOptions Map(CommonGeometryOptions g, EccOptions e, HalconNccOptions n, PhaseCorrelationOptions p)
        {
            var o = new MatcherOptions 
            { 
                MinTextureStdDev = g.MinTextureStdDev, 
        ...
        public static AlignStitchConfig CloneForRun(AlignStitchConfig source, string outputPath)
        {
            ...
            c.Recovery = new RecoveryFallbackOptions
            { 
                RecoverFailedTiles = source.Recovery.RecoverFailedTiles,
                ...
                RequireManualConfirmationForExpectedGrid = source.Recovery.RequireManualConfirmationForExpectedGrid, 
            ...
            c.Stitching = new StitchingOptions 
            { 
                Engine = source.Stitching.Engine, 
                AllowUnsafeLegacyHalconProjectiveMosaic = source.Stitching.AllowUnsafeLegacyHalconProjectiveMosaic,
        ...
        { 
            ...
            { 
                ...
                Geometry=new CommonGeometryOptions 
                { 
                    MinTextureStdDev=d.Geometry.MinTextureStdDev, 
                ...
                Ncc=new HalconNccOptions 
                { 
                    MinScore=d.Ncc.MinScore, 
                    NumLevels=d.Ncc.NumLevels, 
                    AngleStartRad=d.Ncc.AngleStartRad, 
                    AngleExtentRad=d.Ncc.AngleExtentRad, 
                    AngleStepRad=d.Ncc.AngleStepRad, 
                    Metric=d.Ncc.Metric, 
                    MaxMatches=d.Ncc.MaxMatches, 
                    MaxOverlap=d.Ncc.MaxOverlap, 
                    SubPixel=d.Ncc.SubPixel, 
                    ModelRoiMarginPixels=d.Ncc.ModelRoiMarginPixels 
                }, 
                Shape=Clone(d.Shape), 
                Ecc=Clone(d.Ecc), 
                Policy=new DirectPipelinePolicy 
                { 
                    AllowCoarseOnlyAcceptance=d.Policy.AllowCoarseOnlyAcceptance, 
                    AllowRefinementFromExpectedWhenCoarseFails=d.Policy.AllowRefinementFromExpectedWhenCoarseFails 
                },
        ...
        private static DirectEvaluationOptions Clone(DirectEvaluationOptions value)
        {
            ...
            return new DirectEvaluationOptions
            {
                ReportOnlyEnabled = value.ReportOnlyEnabled, SelectionPolicy = value.SelectionPolicy,
                MinRefinementGain = value.MinRefinementGain, MaxRefinementDeltaTranslationPixels = value.MaxRefinementDeltaTranslationPixels,
                MaxRefinementDeltaRotationDeg = value.MaxRefinementDeltaRotationDeg, Tier1MaximumSide = value.Tier1MaximumSide,
                Tier2MaximumSide = value.Tier2MaximumSide, AmbiguousScoreGap = value.AmbiguousScoreGap,
                EdgeWeight = value.EdgeWeight, GradientNccWeight = value.GradientNccWeight,
                ValidOverlapWeight = value.ValidOverlapWeight, BorderPenaltyWeight = value.BorderPenaltyWeight,
                EdgeDistanceTolerancePixels = value.EdgeDistanceTolerancePixels, MinimumGradientStdDev = value.MinimumGradientStdDev
            };
        }
        ...
        { 
            ...
            { 
                ...
                Phase=new PhaseCorrelationOptions 
                { 
                    MinResponse=n.Phase.MinResponse, 
                    PyramidLevels=n.Phase.PyramidLevels 
                }, 
                Ecc=Clone(n.Ecc), 
                Acceptance=new NeighborAcceptanceOptions 
                { 
                    MinOverlapRatio=n.Acceptance.MinOverlapRatio,
                    MaxTranslationPixels=n.Acceptance.MaxTranslationPixels,
                    MaxAbsRotationDeg=n.Acceptance.MaxAbsRotationDeg, 
        ...
        private static GerberViewer.Stitching.Alignment.Graph.PoseGraphOptions Clone(GerberViewer.Stitching.Alignment.Graph.PoseGraphOptions p)
        {
        ...
        { 
            return new EccOptions 
            { 
                MotionModel=e.MotionModel, 
                PyramidLevels=e.PyramidLevels, 
                MaxIterations=e.MaxIterations, 
                Epsilon=e.Epsilon, 
                MinCorrelation=e.MinCorrelation 
        ...
        public static EffectiveConfigSnapshot CreateSnapshot(AlignStitchConfig c)
        {
            ...
            Add(list,
                ...
                "Pose",
                "ManualOffsetX",
                c.DirectAlignment.ManualOffsetX,
                c.DirectAlignment.ManualOffsetX,
                "User config",
                "AlignStitchWorkflowService");
            Add(list,
                "Direct",
                "Pose",
                "ManualOffsetY",
                c.DirectAlignment.ManualOffsetY,
                c.DirectAlignment.ManualOffsetY,
                "User config",
                "AlignStitchWorkflowService");
            Add(list,
                ...
                "Pipeline",
                "CoarseMatcher",
                c.DirectAlignment.CoarseMatcher,
                directMatcher(c.DirectAlignment.CoarseMatcher),
                "User config","Direct matcher pipeline"); 
            Add(list,
                "Direct",
                "Pipeline",
                "RefinementMatcher",
                c.DirectAlignment.RefinementMatcher,
                c.DirectAlignment.RefinementMatcher,
                "User config","Direct matcher pipeline");
            Add(list,
                "Direct",
                "NCC",
                "MinScore",
                c.DirectAlignment.Ncc.MinScore,
                d.NccMinScore,
            ...
            Add(list,
                ...
                "ECC",
                "MaxIterations",
                c.DirectAlignment.Ecc.MaxIterations,
                d.MaxIterations,
            ...
            Add(list,
                ...
                "NCC",
                "NumLevels",
                c.DirectAlignment.Ncc.NumLevels,
                d.NccNumLevels,
                "User config","HalconNccMatcher"); 
            Add(list,
                "Direct",
                "NCC",
                "AngleStartRad",
                c.DirectAlignment.Ncc.AngleStartRad,
                d.NccAngleStartRad,
                "User config",
                "HalconNccMatcher"
                ); 
            Add(list,
                ...
                "NCC",
                "AngleExtentRad",
                c.DirectAlignment.Ncc.AngleExtentRad,
                d.NccAngleExtentRad,
                "User config","HalconNccMatcher"); 
            Add(list,
                "Direct",
                "NCC",
                "AngleStepRad",
                c.DirectAlignment.Ncc.AngleStepRad,
                d.NccAngleStepRad,
                "User config","HalconNccMatcher"); 
            Add(list,
                "Direct",
            ...
            Add(list,
                ...
                "NCC",
                "MaxMatches",
                c.DirectAlignment.Ncc.MaxMatches,
                d.NccMaxMatches,
                "User config","HalconNccMatcher"
                ); 
            Add(list,
                ...
                "NCC",
                "MaxOverlap",
                c.DirectAlignment.Ncc.MaxOverlap,
                d.NccMaxOverlap,
                "User config","HalconNccMatcher"); 
            Add(list,
                "Direct",
                "NCC",
                "SubPixel",
                c.DirectAlignment.Ncc.SubPixel,
                d.NccSubPixel,
                "User config","HalconNccMatcher"); 
            Add(list,
                "Direct",
                "NCC",
                "ModelRoiMarginPixels",
                c.DirectAlignment.Ncc.ModelRoiMarginPixels,
                d.NccModelRoiMarginPixels,
                "User config",
                "HalconNccModelProvider"
                );
            Add(list,
                "Direct",
                "Shape",
                "MinScore",
                c.DirectAlignment.Shape.MinScore,
                c.DirectAlignment.Shape.MinScore,
                "User config",
                "HalconShapeModelMatcher"); 
            Add(list,
                "Direct",
                "Shape",
                "Greediness",
                c.DirectAlignment.Shape.Greediness,
                c.DirectAlignment.Shape.Greediness,"User config","HalconShapeModelMatcher"); Add(list,"Direct","Shape","Mode",c.DirectAlignment.Shape.Mode,c.DirectAlignment.Shape.Mode,"User config","HalconShapeModelMatcher"); Add(list,"Direct","Shape","NumLevels",c.DirectAlignment.Shape.NumLevels,c.DirectAlignment.Shape.NumLevels,"User config","HalconShapeModelProvider"); Add(list,"Direct","Shape","Contrast",c.DirectAlignment.Shape.Contrast,c.DirectAlignment.Shape.Contrast,"User config","HalconShapeModelProvider"); Add(list,"Direct","Shape","MinContrast",c.DirectAlignment.Shape.MinContrast,c.DirectAlignment.Shape.MinContrast,"User config","HalconShapeModelProvider");
            Add(list,
                "Direct",
                "ECC",
                "MotionModel",
                c.DirectAlignment.Ecc.MotionModel,
                d.EccMotionModel,
                "User config",
                "PyramidEccMatcher"); 
            Add(list,
                ...
                "ECC",
                "PyramidLevels",
                c.DirectAlignment.Ecc.PyramidLevels,
                d.PyramidLevels,
                "User config",
                "PyramidEccMatcher"); 
            Add(list,
                ...
                "ECC",
                "MinCorrelation",
                c.DirectAlignment.Ecc.MinCorrelation,
                d.MinCorrelation,
                "User config",
                "PyramidEccMatcher"); 
            Add(list,
                ...
                c.DirectAlignment.Policy.AllowCoarseOnlyAcceptance,
                c.DirectAlignment.Policy.AllowCoarseOnlyAcceptance,
                "User config",
            ...
            Add(list,
                ...
                "Phase",
                "MinResponse",
                c.NeighborAlignment.Phase.MinResponse,
                n.PhaseMinResponse,
                "User config",
            ...
            Add(list,
                ...
                "ECC",
                "MinCorrelation",
                c.NeighborAlignment.Ecc.MinCorrelation,
                n.MinCorrelation,
                "User config",
                "PyramidEccMatcher");
            Add(list,
                ...
                "Pipeline",
                "CoarseMatcher",
                c.NeighborAlignment.CoarseMatcher,
                c.NeighborAlignment.CoarseMatcher,
                "User config",
                "Neighbor recovery pipeline"
                ); 
            Add(list,
                "Neighbor",
                "Pipeline",
                "RefinementMatcher",
                c.NeighborAlignment.RefinementMatcher,
                c.NeighborAlignment.RefinementMatcher,
                "User config",
                "Neighbor recovery pipeline"); 
            Add(list,
                ...
                "Phase",
                "PyramidLevels",
                c.NeighborAlignment.Phase.PyramidLevels,
                c.NeighborAlignment.Phase.PyramidLevels,
                "User config",
                "PyramidPhaseCorrelationMatcher"); 
            Add(list,
                ...
                "ECC",
                "MotionModel",
                c.NeighborAlignment.Ecc.MotionModel,
                n.EccMotionModel,
                "User config",
                "PyramidEccMatcher"); 
            Add(list,
                ...
                "ECC",
                "PyramidLevels",
                c.NeighborAlignment.Ecc.PyramidLevels,
                n.PyramidLevels,
                "User config",
                "PyramidEccMatcher"); 
            Add(list,
                ...
                "ECC",
                "MaxIterations",
                c.NeighborAlignment.Ecc.MaxIterations,
                n.MaxIterations,
                "User config",
                "PyramidEccMatcher"
                ); 
            Add(list,
                ...
                "ECC",
                "Epsilon",
                c.NeighborAlignment.Ecc.Epsilon,
                n.Epsilon,
                "User config",
                "PyramidEccMatcher");
            Add(list,
            ...
            Add(list,
                ...
                "Preprocessing",
                "Contrast",
                c.DirectAlignment.Preprocessing.Contrast,
                c.DirectAlignment.Preprocessing.Contrast,
                "User config",
                "OpenCV/HALCON input preprocessing");
            Add(list,
                "Direct",
                "Geometry",
                "MinTextureStdDev",
                c.DirectAlignment.Geometry.MinTextureStdDev,
                d.MinTextureStdDev,
                "User config",
            ...
            Add(list,
                ...
                "Geometry",
                "MinOverlapRatio",
                c.DirectAlignment.Geometry.MinOverlapRatio,
                d.MinOverlapRatio,
                "User config",
                "MatcherGeometryValidator"); 
            Add(list,
                ...
                c.DirectAlignment.Geometry.MaxTranslationPixels,
                d.MaxTranslationPixels,
                "User config",
                "MatcherGeometryValidator"); 
            Add(list,
                "Direct",
                "Geometry",
                "MaxAbsRotationDeg",
                c.DirectAlignment.Geometry.MaxAbsRotationDeg,
                d.MaxAbsRotationDeg,
                "User config",
                "MatcherGeometryValidator"); 
            Add(list,
                ...
                "Geometry",
                "MinScale",
                c.DirectAlignment.Geometry.MinScale,
                d.MinScale,
                "User config",
                "MatcherGeometryValidator"); 
            Add(list,
                ...
                "Geometry",
                "MaxScale",
                c.DirectAlignment.Geometry.MaxScale,
                d.MaxScale,
                "User config",
                "MatcherGeometryValidator");
            Add(list,
                ...
                "Acceptance",
                "MinOverlapRatio",
                c.NeighborAlignment.Acceptance.MinOverlapRatio,
                n.MinOverlapRatio,
                "User config",
            ...
            Add(list,
                ...
                "Acceptance",
                "MaxTranslationPixels",
                c.NeighborAlignment.Acceptance.MaxTranslationPixels,
                n.MaxTranslationPixels,
                "User config",
                "NeighborMatchAcceptance"); 
            Add(list,
                "Neighbor",
                "Acceptance",
                "MaxAbsRotationDeg",
                c.NeighborAlignment.Acceptance.MaxAbsRotationDeg,
                n.MaxAbsRotationDeg,
                "User config",
                "NeighborMatchAcceptance"); 
            Add(list,
                ...
                "Acceptance",
                "MinScale",
                c.NeighborAlignment.Acceptance.MinScale,
                n.MinScale,
                "User config",
                "NeighborMatchAcceptance"); 
            Add(list,
                ...
                "Acceptance",
                "MaxScale",
                c.NeighborAlignment.Acceptance.MaxScale,
                n.MaxScale,
                "User config",
                "NeighborMatchAcceptance"); 
            Add(list,
                ...
                "Fallback",
                "RecoverFailedTiles",
                c.Recovery.RecoverFailedTiles,
                c.Recovery.RecoverFailedTiles,
                "User config",
                "AlignStitchWorkflowService.Recover");
            Add(list,
                "Recovery",
                "Neighbor graph modes",
                "ReconcileAllMatchedTiles",
                c.Recovery.ReconcileAllMatchedTiles,
                c.Recovery.ReconcileAllMatchedTiles,
                "User config",
            ...
            Add(list,
                "Recovery",
                "Fallback",
                "EnableAnchorInterpolation",
                c.Recovery.EnableAnchorInterpolation,
                c.Recovery.EnableAnchorInterpolation,
                "User config",
                "AlignmentPoseInterpolator");
            Add(list,
                "Recovery",
                "Fallback",
                "EnableManualAlignment",
                c.Recovery.EnableManualAlignment,
                c.Recovery.EnableManualAlignment,
                "User config",
                "AlignStitchWorkflowService"); 
            Add(list,
                "Recovery",
                "Fallback",
                "AutoPlaceExactZeroSample",
                c.Recovery.AutoPlaceExactZeroSample,
                c.Recovery.AutoPlaceExactZeroSample,
                "User config",
                "AlignStitchWorkflowService"); 
            Add(list,
                "Recovery",
                "Fallback",
                "AutoPlaceLowTextureSample",
                c.Recovery.AutoPlaceLowTextureSample,
                c.Recovery.AutoPlaceLowTextureSample,
                "User config",
                "AlignStitchWorkflowService"); 
            Add(list,
                "Recovery",
                "Fallback",
                "AllowExpectedGridFallback",
                c.Recovery.AllowExpectedGridFallback,
                c.Recovery.AllowExpectedGridFallback,
                "User config",
                "AlignStitchWorkflowService"); 
            Add(list,
            ...
            Add(list,
                "Recovery",
                "Content",
                "RevalidateSampleContent",
                c.Recovery.RevalidateSampleContent,
                c.Recovery.RevalidateSampleContent,
                "User config",
                "SampleTileContentAnalyzer"); 
            Add(list,
                "Recovery",
                "Content",
                "LowTextureStdDevThreshold",
                c.Recovery.LowTextureStdDevThreshold,
                c.Recovery.LowTextureStdDevThreshold,
                "User config",
                "SampleTileContentAnalyzer");
            Add(list,
            ...
            Add(list,
                ...
                "Blend",
                "BlendMode",
                c.Stitching.BlendMode,
                s.EffectiveBlendMode,
                "User config + pixel format policy",
                "GlobalTransformStitcher"); 
            Add(list,
                "Stitching",
                "Output",
                "ForceGray8Output",
                c.Stitching.ForceGray8Output,
                s.ForceGray8Output,
                "User config",
                "GlobalTransformStitcher"); 
            Add(list,
                "Stitching",
                "Fallback",
                "BlankFallbackOverlapPolicy",
                c.Stitching.BlankFallbackOverlapPolicy,
                s.BlankFallbackOverlapPolicy,
                "User config",
                "GlobalTransformStitcher");
            Add(list,
                "Output",
            ...
            Add(list,
                ...
                c.Output.PreviewUpdateInterval,
                s.PreviewUpdateInterval,
                "User config",
                "GlobalTransformStitcher"); 
            Add(list,
                "Output",
                "Preview",
                "MaxPreviewMegapixels",
                c.Output.MaxPreviewMegapixels,
                s.MaxPreviewMegapixels,
                "User config",
                "GlobalTransformStitcher");
            Add(list, "PoseGraph", "Solver", "Enabled", c.PoseGraph.Enabled, c.PoseGraph.Enabled, "User config", "GlobalPoseGraphOptimizer");
            Add(list, "PoseGraph", "Prior weights", "LambdaDirect", c.PoseGraph.LambdaDirect, c.PoseGraph.LambdaDirect, "User config", "GlobalPoseGraphOptimizer");
            Add(list, "PoseGraph", "Prior weights", "LambdaWeak", c.PoseGraph.LambdaWeak, c.PoseGraph.LambdaWeak, "User config", "GlobalPoseGraphOptimizer");
            Add(list, "PoseGraph", "Prior weights", "LambdaBlank", c.PoseGraph.LambdaBlank, c.PoseGraph.LambdaBlank, "User config", "GlobalPoseGraphOptimizer");
            Add(list, "PoseGraph", "Prior weights", "LambdaPinned", c.PoseGraph.LambdaPinned, c.PoseGraph.LambdaPinned, "User config", "GlobalPoseGraphOptimizer");
            Add(list, "PoseGraph", "Solver", "RotationScalePixels", c.PoseGraph.RotationScalePixels, c.PoseGraph.RotationScalePixels, "User config", "PoseGraphSolver");
            Add(list, "PoseGraph", "Solver", "HuberPixels", c.PoseGraph.HuberPixels, c.PoseGraph.HuberPixels, "User config", "PoseGraphSolver");
            Add(list, "PoseGraph", "Solver", "MaxIterations", c.PoseGraph.MaxIterations, c.PoseGraph.MaxIterations, "User config", "PoseGraphSolver");
            Add(list, "PoseGraph", "Solver", "MaxCgIterations", c.PoseGraph.MaxCgIterations, c.PoseGraph.MaxCgIterations, "User config", "SparseNormalEquationCg");
            Add(list, "PoseGraph", "Solver", "CgTolerance", c.PoseGraph.CgTolerance, c.PoseGraph.CgTolerance, "User config", "SparseNormalEquationCg");
            Add(list, "PoseGraph", "Global similarity", "EstimateGlobalScale", c.PoseGraph.EstimateGlobalScale, c.PoseGraph.EstimateGlobalScale, "User config", "GlobalSimilarityFit");
            Add(list, "PoseGraph", "Global similarity", "MinGlobalScale", c.PoseGraph.MinGlobalScale, c.PoseGraph.MinGlobalScale, "User config", "GlobalSimilarityFit");
            Add(list, "PoseGraph", "Global similarity", "MaxGlobalScale", c.PoseGraph.MaxGlobalScale, c.PoseGraph.MaxGlobalScale, "User config", "GlobalSimilarityFit");
            Add(list, "PoseGraph", "Global similarity", "MaxGlobalRotationDeg", c.PoseGraph.MaxGlobalRotationDeg, c.PoseGraph.MaxGlobalRotationDeg, "User config", "GlobalSimilarityFit");
            Add(list, "PoseGraph", "Edge gate", "UseRejectedEdges", c.PoseGraph.UseRejectedEdges, c.PoseGraph.UseRejectedEdges, "User config", "GlobalPoseGraphOptimizer");
            Add(list, "PoseGraph", "Edge gate", "MaxEdgeResidualPixels", c.PoseGraph.MaxEdgeResidualPixels, c.PoseGraph.MaxEdgeResidualPixels, "User config", "GlobalPoseGraphOptimizer");
            Add(list, "PoseGraph", "Edge gate", "MaxEdgeRotationDeg", c.PoseGraph.MaxEdgeRotationDeg, c.PoseGraph.MaxEdgeRotationDeg, "User config", "GlobalPoseGraphOptimizer");
            Add(list, "PoseGraph", "Safety", "MaxPoseCorrectionPixels", c.PoseGraph.MaxPoseCorrectionPixels, c.PoseGraph.MaxPoseCorrectionPixels, "User config", "GlobalPoseGraphOptimizer");
            return new EffectiveConfigSnapshot(list);
        }
        private static object directMatcher(DirectCoarseMatcherKind k) { return k; }
        private static void Add(IList<EffectiveConfigEntry> l,
            string s,
            string g,
            string p,
            object c,
            ...
            string used) 
        { 
            l.Add(new EffectiveConfigEntry 
            { 
                Stage=s,
                Group=g,
                Parameter=p,
