...
namespace GerberViewer.Stitching.Utils
{
    ...
    {
        public static Task SaveTiffGray8Async(string outputPath, int width, int height, byte[] pixels,
                                              CancellationToken cancellationToken = default(CancellationToken))
        {
            Validate(outputPath, width, height, pixels, 1);
        ...
        public static Task SaveTiffRgb24Async(string outputPath, int width, int height, byte[] pixelsRgb,
                                              CancellationToken cancellationToken = default(CancellationToken))
        {
