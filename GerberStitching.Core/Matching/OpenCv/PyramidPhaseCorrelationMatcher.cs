...
namespace GerberViewer.Stitching.Matching.OpenCv
{
    public sealed class PyramidPhaseCorrelationMatcher : IMatcher
    {
        ...
        public string MatcherName { get { return "PyramidPhaseCorrelationMatcher"; } }
        ...
        public MatchResult Match(MatchRequest request, CancellationToken cancellationToken)
        {
            ...
            if (cancellationToken.IsCancellationRequested)
                return Complete(request, MatchResult.Failed(MatcherName, MatchFailureReason.Cancelled, "Phase correlation was cancelled before start."), sw);
            ...
            {
                return Complete(request, MatchResult.Failed(MatcherName, MatchFailureReason.Cancelled, "Phase correlation was cancelled."), sw);
            }
            catch (Exception ex)
            {
