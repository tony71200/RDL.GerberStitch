...
{
    // [Tony] [Change time: 2026-08-01] [Purpose: Apply the locked lexicographic multi-neighbor selection policy
    // independently of pair measurement.]
    public static class NeighborCandidateRanker
    {
        ...
        private static double FiniteOrMinimum(double value)
        {
            return double.IsNaN(value) || double.IsInfinity(value) ? double.MinValue : value;
        }
